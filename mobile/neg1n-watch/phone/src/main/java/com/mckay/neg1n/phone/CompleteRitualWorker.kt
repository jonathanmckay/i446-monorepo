...
/** Completes one -1n ritual, relayed from the watch's swipe-to-complete
 * list via RitualActionListenerService — the actual /complete HTTP call
 * (over Tailscale, works from wherever the phone is, see Neg1nConfig's
 * DEFAULT_ENDPOINT comment) happens here, then the fresh status goes
 * straight back to the watch's Data Layer. */
